...
namespace crud_demo {
    ...
    public partial class DepartmentDbDataSet : global::System.Data.DataSet {
        ...
        public partial class empDataTable : global::System.Data.TypedTableBase<empRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public empRow AddempRow(string name, string city, string gender, string hobby, string dept) {
        ...
        public partial class empRow : global::System.Data.DataRow {
            ...
            public string hobby {
                get {
                    try {
                        return ((string)(this[this.tableemp.hobbyColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'hobby\' in table \'emp\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableemp.hobbyColumn] = value;
                }
            }
            ...
            public bool IshobbyNull() {
                return this.IsNull(this.tableemp.hobbyColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SethobbyNull() {
                this[this.tableemp.hobbyColumn] = global::System.Convert.DBNull;
            }
...
namespace crud_demo.DepartmentDbDataSetTableAdapters {
    ...
    public partial class empTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[emp] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Original_city)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_hobby = 1 AND [hobby] IS NULL) OR ([hobby] = @Original_hobby)) AND ((@IsNull_dept = 1 AND [dept] IS NULL) OR ([dept] = @Original_dept)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[emp] ([name], [city], [gender], [hobby], [dept]) VALUES (@name" +
                ", @city, @gender, @hobby, @dept);\r\nSELECT Id, name, city, gender, hobby, dept FR" +
                "OM emp WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[emp] SET [name] = @name, [city] = @city, [gender] = @gender, [hobby] = @hobby, [dept] = @dept WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_city = 1 AND [city] IS NULL) OR ([city] = @Original_city)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_hobby = 1 AND [hobby] IS NULL) OR ([hobby] = @Original_hobby)) AND ((@IsNull_dept = 1 AND [dept] IS NULL) OR ([dept] = @Original_dept)));
SELECT Id, name, city, gender, hobby, dept FROM emp WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::crud_demo.Properties.Settings.Default.DepartmentDbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, city, gender, hobby, dept FROM dbo.emp";
        ...
        public virtual int Fill(DepartmentDbDataSet.empDataTable dataTable) {
        ...
        public virtual DepartmentDbDataSet.empDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DepartmentDbDataSet.empDataTable dataTable = new DepartmentDbDataSet.empDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DepartmentDbDataSet.empDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_name, string Original_city, string Original_gender, string Original_hobby, string Original_dept) {
            ...
            if ((Original_hobby == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((string)(Original_hobby));
            }
        ...
        public virtual int Insert(string name, string city, string gender, string hobby, string dept) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string city, string gender, string hobby, string dept, int Original_Id, string Original_name, string Original_city, string Original_gender, string Original_hobby, string Original_dept, int Id) {
            if ((name == null)) {
            ...
            if ((Original_hobby == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_hobby));
            }
            if ((Original_dept == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string city, string gender, string hobby, string dept, int Original_Id, string Original_name, string Original_city, string Original_gender, string Original_hobby, string Original_dept) {
            return this.Update(name, city, gender, hobby, dept, Original_Id, Original_name, Original_city, Original_gender, Original_hobby, Original_dept, Original_Id);
        }
    }
